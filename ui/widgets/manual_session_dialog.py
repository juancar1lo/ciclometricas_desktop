...
def _type_presets():
    return {
        "strength": {
            ...
            "sport": "strength",
            "intensities": [
                (tr("Suave (mantenimiento)"), 0.55),
                (tr("Moderada (hipertrofia)"), 0.70),
                (tr("Alta (fuerza máx.)"), 0.82),
            ],
        },
        "walk": {
            "label": tr("🚶 Caminar"),
            ...
            "intensities": [
                (tr("Paseo suave"), 0.35),
                (tr("Caminata rápida"), 0.48),
                (tr("Marcha intensa"), 0.60),
            ],
        },
        "other": {
            "label": tr("🏃 Otro"),
            "sport": "other",
            "intensities": [
                (tr("Baja intensidad"), 0.40),
                (tr("Intensidad media"), 0.60),
                (tr("Alta intensidad"), 0.78),
            ],
        },
    }
...
class ManualSessionDialog(QDialog):
    ...
    def __init__(self, ftp: int = 0, parent: QWidget | None = None):
        ...
        self.setWindowTitle(tr("Registrar sesión manual"))
        ...
        # ── Tipo de actividad ──
        type_lbl = QLabel(tr("Tipo de actividad"))
        ...
        dur_col = QVBoxLayout()
        dur_lbl = QLabel(tr("Duración (min)"))
        ...
        int_lbl = QLabel(tr("Intensidad percibida (IF)"))
        ...
        if_manual_lbl = QLabel(tr("IF manual:"))
        ...
        tss_title = QLabel(tr("TSS ESTIMADO"))
        ...
        btn_box.button(QDialogButtonBox.StandardButton.Ok).setText(tr("Guardar"))
        btn_box.button(QDialogButtonBox.StandardButton.Cancel).setText(tr("Cancelar"))
