...
# Ciclométricas v3.0 — PyInstaller spec
...
hiddenimports = (
    ...
    [
        ...
        'services.ai_coach',
        'services.data_queries',
        # UI extras
        'ui.views.ai_coach_view',
        'ui.views.spike_editor_view',
        'ui.widgets.manual_session_dialog',
        'ui.charts.spike_chart',
        # i18n
        'i18n',
        'i18n.en',
        # Informes PDF
...
a = Analysis(
    ...
    excludes=[
        ...
        # 'matplotlib' — ahora se usa para informes PDF
        'IPython',
        'notebook',
