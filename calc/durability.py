...
def classify_dri(dri: float) -> Tuple[str, str, str]:
    ...
    if dri >= 95:
        return ("excellent", tr("Excelente durabilidad"), "#22c55e")
    if dri >= 92:
        return ("good", tr("Buena durabilidad"), "#3b82f6")
    if dri >= 88:
        return ("improvable", tr("Mejorable"), "#eab308")
    return ("limiting", tr("Limitante en recorridos largos"), "#ef4444")
